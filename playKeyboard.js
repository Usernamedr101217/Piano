function playKeyboard(){
	...
	let setPiano = document.getElementById('piano');
	let setOrgans = document.getElementById('organs');
	let setAcoustic = document.getElementById('acoustic');

	let selectSound = {
		value: "0" //piano
	};

	setPiano.addEventListener('click', () => {
		selectSound.value = 0;
	})
	setOrgans.addEventListener('click', () => {
		selectSound.value = 1;
	})
	setAcoustic.addEventListener('click', () => {
		selectSound.value = 2;
	})
